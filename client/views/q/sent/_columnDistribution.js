 ...
 */
Template._columnDistribution.rendered = function() {
    var q = QuestionaireForId.find({_id : Session.get('questionnaire_id')}).fetch()[0];
    console.info(q);
...
Template._columnDistribution.onCreated(function(){
